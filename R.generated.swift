...
struct R: Rswift.Validatable {
  ...
  struct image {
    ...
    /// Image `icon_doubleDown`.
    static let icon_doubleDown = Rswift.ImageResource(bundle: R.hostingBundle, name: "icon_doubleDown")
    /// Image `icon_next`.
    ...
    /// Image `icon_previous`.
    static let icon_previous = Rswift.ImageResource(bundle: R.hostingBundle, name: "icon_previous")
    /// Image `icon_search`.
    static let icon_search = Rswift.ImageResource(bundle: R.hostingBundle, name: "icon_search")
    /// Image `icon_stop`.
    static let icon_stop = Rswift.ImageResource(bundle: R.hostingBundle, name: "icon_stop")
    /// Image `img_note`.
    static let img_note = Rswift.ImageResource(bundle: R.hostingBundle, name: "img_note")
    /// Image `tab_search`.
    static let tab_search = Rswift.ImageResource(bundle: R.hostingBundle, name: "tab_search")
    /// Image `tab_setting`.
    static let tab_setting = Rswift.ImageResource(bundle: R.hostingBundle, name: "tab_setting")
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "icon_doubleDown", bundle: ..., traitCollection: ...)`
    static func icon_doubleDown(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.icon_doubleDown, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "icon_previous", bundle: ..., traitCollection: ...)`
    static func icon_previous(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.icon_previous, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "icon_stop", bundle: ..., traitCollection: ...)`
    static func icon_stop(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.icon_stop, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "img_note", bundle: ..., traitCollection: ...)`
    static func img_note(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.img_note, compatibleWith: traitCollection)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "tab_setting", bundle: ..., traitCollection: ...)`
    static func tab_setting(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.tab_setting, compatibleWith: traitCollection)
    }
    #endif
